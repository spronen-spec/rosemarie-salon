  ...
  return (
    <section id="highlights" className="section-padding bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-[2rem] border border-border/70 bg-gradient-to-br from-cream via-background to-secondary/80 p-8 md:p-12 lg:p-16 shadow-sm">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="font-body text-sm tracking-widest uppercase px-6 py-3 gold-gradient text-accent-foreground rounded-sm hover:opacity-90 transition-opacity"
                >
                  Book Your Visit
                </a>
                <a
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {highlights.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-11 h-11 rounded-full gold-gradient flex items-center justify-center mb-4">
